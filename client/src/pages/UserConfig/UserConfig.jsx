  ...
  return (
    <div className="UserConfig">
      <div className="UserConfig__form blurred-box">
        <div className="UserConfig__Title">
          <span className="Super">Super</span>
          <span className="Verse"> Verse</span>
        </div>
        <div className="UserConfig__About">
          Dive Into The DragonBall and Naruto Verse
        </div>
      ...
      <audio
        src="https://res.cloudinary.com/drolmjcot/video/upload/v1610367006/audio/bluebird_juhczs.mp3"
        id="audio"
        preload="metadata"
        type="audio/mpeg"
        loop
